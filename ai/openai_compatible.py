...
agnostic.  OpenRouter is the default provider, but another compatible base URL
and model can be supplied through environment variables.
"""
...
class LLMConfig:
    ...
    def from_env(cls, environ: Mapping[str, str] | None = None) -> "LLMConfig":
        ...
        api_key = source.get("AI_LLM_API_KEY") or source.get("OPENROUTER_API_KEY")
        return cls(
