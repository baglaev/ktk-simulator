...
_ERROR_CARDS = {
    ...
    ActionErrorCode.WRONG_DIAGNOSIS_REASON: _card("diagnostics", "Указана неверная причина.", "Выбран ошибочный учебный вывод.", "Сопоставьте все признаки COMPAX и связанные технологические тренды.", "Неверная причина приведёт к неправильному учебному решению.", ["submit-diagnosis"], "Диагностика Н-1А", "Выбрать износ подшипника после проверки признаков."),
